#include "Jugador_Intermedio.h"
#include "Manager.h"
#include "algorithm"



Jugador_IM::Jugador_IM(int id, Manager* mg) : Jugador_RULES(id, mg)
{}


std::string Jugador_IM::identificar() {
	std::ostringstream str;
	str << "[PLAYER] IA_RULES_IM, id: " << Jugador::identificar();
	return str.str();
}


int Jugador_IM::Rules(std::vector<Carta> mesa){
